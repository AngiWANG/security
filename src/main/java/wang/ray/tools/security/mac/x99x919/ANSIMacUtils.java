package wang.ray.tools.security.mac.x99x919;
...
//		97F4CAACC9AC54A8
		byte[] result = calculateANSIX9_9MAC(ByteUtil.getHexByte(mak22),data.getBytes("utf-8"));
		System.out.print(ByteUtil.getHexStr(result));
